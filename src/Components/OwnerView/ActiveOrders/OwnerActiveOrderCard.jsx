...
import './OwnerActiveOrderCard.css';
...
class OwnerActiveOrderCard extends Component {
    ...
    render() {
        return (
            <Card
                className="owner-active-order-card"
                title="Taylor Rotolo"
                // extra={<Button type="primary" size="large">Ready</Button>}
                extra={<div>
                    <Button type="danger" size="large"
                        style={{ marginRight: '8px' }}>Reject</Button>
                    <Button type="primary" size="large">Accept</Button>
                </div>}
            >
                <Steps
                ...
                <Collapse bordered={false}>
                    <Panel className="owner-active-order-card-panel" header="Order Summary" key="1">
                        <Row>
                    ...
                    {/* <Divider /> */}
                    <Panel className="owner-active-order-card-panel" header="Order Details" key="2">
